...
namespace engine::render
{
    ...
    public:
        ...
        {
            utils::AlwaysAssert(direct3d::device->CreateGeometryShader(blob().ptr(), blob().size(), nullptr, &gs.ptr()) >= 0,
                                "Failed to create vertex shader");
        }
        void Bind() override
        {
            direct3d::devcon->GSSetShader(gs, nullptr, 0);
        }
        void Unbind() override
        {
            direct3d::devcon->GSSetShader(nullptr, nullptr, 0);
        }
