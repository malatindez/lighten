...
namespace lighten::direct3d
{
    ...
    public:
        ...
        /// @brief Greater or equal depth test, depth write disabled, stencil test enabled, stencil write enabled
        /// @details This state is equivalent to the following D3D11_DEPTH_STENCIL_DESC:
        /// * DepthEnable = false
        /// * DepthWriteMask = D3D11_DEPTH_WRITE_MASK_ALL
        /// * DepthFunc = D3D11_COMPARISON_GREATER_EQUAL
        ...
        /// * BackFace.StencilPassOp = D3D11_STENCIL_OP_REPLACE
        /// * BackFace.StencilFunc = D3D11_COMPARISON_ALWAYS
        ReadOnlyDepthStencilState no_depth_stencil_replace;
        ...
        /// * BackFace.StencilPassOp = D3D11_STENCIL_OP_KEEP
        /// * BackFace.StencilFunc = D3D11_COMPARISON_EQUAL
        ReadOnlyDepthStencilState no_depth_stencil_read;
    ...
    private:
        ...
        static void Init()
        {
            mal_toolkit::Assert(instance_ == nullptr, "States already initialized");
