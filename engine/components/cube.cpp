...
namespace engine::components
{
    ...
    std::array<Triangle, 12> Cube::triangles_{
        Triangle{kCubeVertices[4], kCubeVertices[2], kCubeVertices[0], kCubeNormals[0]},
        ...
        Triangle{kCubeVertices[1], kCubeVertices[7], kCubeVertices[5], kCubeNormals[3]},
        ...
        Triangle{kCubeVertices[4], kCubeVertices[6], kCubeVertices[2], kCubeNormals[0]},
        ...
        Triangle{kCubeVertices[1], kCubeVertices[3], kCubeVertices[7], kCubeNormals[3]},
