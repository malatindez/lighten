...
#define EVENT_CLASS_TYPE(event_type)                                        \
    ...
    [[nodiscard]] EventType type() const override { return static_type(); } \
...
#define EVENT_CLASS_CATEGORY(category) \
    [[nodiscard]] uint8_t category_flags() const override { return category; }
namespace engine
{
    ...
    public:
        ...
        [[nodiscard]] virtual uint8_t category_flags() const = 0;
        [[nodiscard]] bool in_category(uint8_t category) const { return (category & category_flags()); }
