...
namespace engine::core
{
    ...
    public:
        ...
        void DeferredRender(render::GBuffer const &buffer, ID3D11DepthStencilView *dsv)
        {
            utils::Assert(renderer != nullptr, "Renderer is null");
            renderer->DeferredRender(this, buffer, dsv);
        }
        void ForwardRender(render::PerFrame const &per_frame, render::GBuffer const &buffer, ID3D11DepthStencilView *dsv)
        {
            utils::Assert(renderer != nullptr, "Renderer is null");
            renderer->ForwardRender(this, per_frame, buffer, dsv);
        }
