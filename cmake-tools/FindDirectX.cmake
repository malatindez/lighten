...
# Find the include paths, they will typically look something like this.
...
find_path(DirectX_DXGI_INCLUDE_DIR
          ...
          set(DirectX_D3D11_INCLUDE_DIRS ${DirectX_D3D11_INCLUDE_DIR} ${DirectX_DXGI_INCLUDE_DIR})
set(DirectX_D3D12_INCLUDE_DIRS ${DirectX_D3D12_INCLUDE_DIR} ${DirectX_DXGI_INCLUDE_DIR})
set(DirectX_D3D11_INCLUDE_DIRS ${DirectX_D3D11_INCLUDE_DIR} ${DirectX_DXGI_INCLUDE_DIR})
...
# handle the QUIETLY and REQUIRED arguments and set DirectX12_FOUND to TRUE
# if all listed variables are TRUE
find_package_handle_standard_args(DirectX11  DEFAULT_MSG DirectX_D3D11_INCLUDE_DIRS DirectX_D3D11_LIBRARIES)
find_package_handle_standard_args(DirectX12  DEFAULT_MSG DirectX_D3D12_INCLUDE_DIRS DirectX_D3D12_LIBRARIES)

mark_as_advanced(DirectX_D3D11_INCLUDE_DIRS DirectX_D3D11_LIBRARIES)
mark_as_advanced(DirectX_D3D12_INCLUDE_DIRS DirectX_D3D12_LIBRARIES)
