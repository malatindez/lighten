...
public:
    ...
    Controller(std::shared_ptr<Renderer> renderer, std::shared_ptr<engine::platform::windows::HDRRenderPipeline> hdr_render_pipeline);
...
private:
    std::shared_ptr < engine::platform::windows::HDRRenderPipeline> hdr_render_pipeline_;
