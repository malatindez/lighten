...
Renderer::Renderer()
{
    ...
    auto vertex_path = path / "assets/shaders/opaque/vs.hlsl";
    auto pixel_path = path / "assets/shaders/opaque/ps.hlsl";
...
#pragma warning(pop)
        ...
        for (auto &mesh : cube->meshes)
        {
            ...
            direct3d::api::devcon4->IASetVertexBuffers(0, 1, &mesh.vertices.buffer(), &stride, &offset);
            direct3d::api::devcon4->IASetIndexBuffer(mesh.indices.buffer(), DXGI_FORMAT_R32_UINT, 0);

            direct3d::api::devcon4->PSSetShaderResources(0, 1, &mesh.materials[0].texture.ptr());
