...
float3 AcesHdrToLdr(float3 hdr) {
  const float3x3 m1 = float3x3(0.59719f, 0.07600f, 0.02840f, 0.35458f, 0.90834f,
                               0.13383f, 0.04823f, 0.01566f, 0.83777f);
  const float3x3 m2 =
      float3x3(1.60475f, -0.10208, -0.00327f, -0.53108f, 1.10813, -0.07276f,
